...
const SubmissionCard = ({ data }: Props) => {
  ...
  return (
    ...
    >
      ...
      <p style={{ margin: '4px 0' }}><b>Age:</b> {data.age}</p>
      <p style={{ margin: '4px 0', wordBreak: 'break-all' }}><b>Email:</b> {data.email}</p>
      <p style={{ margin: '4px 0' }}><b>Country:</b> {data.country}</p>
      <p style={{ margin: '4px 0' }}><b>Gender:</b> {data.gender}</p>
    </div>
  );
};
